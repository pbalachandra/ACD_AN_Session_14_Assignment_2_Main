package com.acadgild.balu.acd_an_session_14_assignment_2_main;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v)
    {
           ...
           (editText_phone.getText().toString().isEmpty()))
        {
            ...
            Insert_Contact(editText_name.getText().toString(), editText_phone.getText().toString());
        }
    }
    ...
    private void Insert_Contact(String name, String phone)
    {
        ...
        if (cursor.getCount() > 0) {
            while (cursor.moveToNext()) {
                String existName = cursor.getString(cursor.getColumnIndex(ContactsContract.Contacts.DISPLAY_NAME));
        ...
        contentProvider.add(ContentProviderOperation.newInsert(ContactsContract.RawContacts.CONTENT_URI)
                .withValue(ContactsContract.RawContacts.ACCOUNT_TYPE, "test@gmail.com")
